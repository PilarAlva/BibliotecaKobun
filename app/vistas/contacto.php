    ...
    <main class="main-content">
        ...
        <p> Informacion de contacto </p>
           <div class="">
            ...
            <div class="">
                <form action="<?php BASE_URL?>contacto/enviar" method="POST">

                    <h5>FORMULARIO</h5>

                    <label>Nombre</label>
                    <input class="" type="text" placeholder="Nombre" name="nombre" required
                    <?php if ($registrado) echo "value = '" . $usuario['usuario_nombre'] . "' readonly"; ?>       
                    />
                    
                    <label for="email">Email</label>
                    <input class="" type="email" placeholder="Mail@ejemplo.com" name="email" required id="email"
            ...
            <div class="">
                <h5>HORARIOS DE ATENCIÓN</h5>
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3282.7582198646764!2d-58.4448133898727!3d-34.63554977283005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bccbcac53e97b9%3A0xb6e749a09c317752!2sInstituto%20de%20Formaci%C3%B3n%20T%C3%A9cnica%20Superior%20N%C2%BA%2027!5e0!3m2!1ses!2sar!4v1756511829973!5m2!1ses!2sar" 
                            height="200" style="" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                        </iframe>
